...
public class CFila {
	...
	// final da fila.
	public void enfileira(CMorador valorItem) {
	...
	public void impressaoSimples() {
		System.out.println(" LISTA DE MORADORES (PÁGINA 1) ");
		System.out.println(" ==============================");
		System.out.println(" FAIXA 1");
		for (CCelula d = frente.prox; d != null; d = d.prox) {
			if (!d.item.getFaixa()) {

				System.out.println(d.item.toSimples());
